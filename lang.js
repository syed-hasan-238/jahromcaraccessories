...
const JUHRUM_LANGS = {
  ...
  en: {
    ...
    t: {
      ...
      story_ch1_b1:'Founded over two decades ago in the heart of Sharjah, Juhrum was built on a single belief: that every truck deserves expert-level attention and precision craftsmanship. What started as a specialist workshop became the UAE's most trusted pickup truck accessories destination.',
      ...
      story_ch1_b3:'More than over 22 years later, Juhrum has become the go-to destination for pickup truck owners across the UAE who refuse to compromise.',
