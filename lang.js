...
const JUHRUM_LANGS = {
  ...
  en: {
    ...
    t: {
      ...
      ts_p0_desc:'Every Juhrum build starts with the stock truck — a blank canvas. We assess the vehicle, plan the build, and source every accessory to spec. Nothing gets fitted that doesn\'t belong.',
      ts_p0_hint:'↓ Keep scrolling',
      ts_p1_title:'Full Safari Build',
      ts_p1_desc:'Lights on. Accessories locked in. This is the complete Juhrum treatment — every exterior mod fitted flush, every light dialled in. Built for the UAE desert and beyond.',
      ...
      ts_p5_desc:'Roof racks, snorkels, winches, lighting rigs, PPF, audio builds — the full Juhrum range. Every accessory sourced, every fitment guaranteed.',
      ...
      stage1_text:'Industrial Area 4. 2019. One rule: serious trucks deserve serious gear. Everything else is negotiable.',
      ...
      contact_btn_wa:'Message on WhatsApp', contact_btn_call:'Call: 050 302 1700',
      ...
      story_ch1_b1:'The story of Juhrum begins not in the UAE, but in Iran — a country with one of the most passionate car cultures in the world. Founded by Hadi Ghanaatian, Juhrum carries the DNA of Persian attention to detail: the belief that anything worth doing is worth doing perfectly.',
      ...
      story_ch1_b3:'More than five years later, Juhrum has become the go-to destination for pickup truck owners across the UAE who refuse to compromise.',
      ...
      story_ch2_b2:'We don\'t. Every product at Juhrum has been tested against this climate — not in a lab, but in the real heat of Sharjah summers. Bed covers that lock out desert dust. PPF that doesn\'t yellow. Thermal insulation that actually works.',
      ...
      story_ch3_b1:'Ram TRX. F-150 Raptor. GMC Sierra Denali. We\'ve built them all. Juhrum specialises in American pickup trucks — the trucks UAE drivers actually choose when they refuse to compromise.',
  ...
  ar: {
    ...
    t: {
      ...
      booking_btn_wa:'واتساب', booking_btn_call:'اتصل: 050 302 1700',
      ...
      contact_btn_wa:'راسلنا على واتساب', contact_btn_call:'اتصل: 050 302 1700',
      contact_email:'h_jahrom@yahoo.com',
