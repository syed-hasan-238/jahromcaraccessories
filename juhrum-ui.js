...
(function () {
  ...
  function initTheme() {
    ...
    var themeOpen = false;
    function openTDD() { themeOpen = true; dd.classList.add('open'); }
    function closeTDD() { themeOpen = false; dd.classList.remove('open'); }
    ...
    document.addEventListener('click', function () { closeTDD(); });
